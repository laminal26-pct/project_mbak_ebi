  ...
  <div class="box">
    <div class="box-header with-border">
      ...
      <div class="pull-right">
        <a type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#createCatModal1">
            ...
            <?php if(count($kat) > 0): ?>
              <?php $__currentLoopData = $kat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td>
                    <?php echo Form::model($kat, ['url' => route('produk.kategori.delete',$k->kategori_produk_id), 'method'=>'delete', 'id' => 'formdelete']); ?>

                    <a href="<?php echo e(route('produk.kategori.edit',$k->kategori_produk_id)); ?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i>&nbsp;Edit</a> &nbsp;
